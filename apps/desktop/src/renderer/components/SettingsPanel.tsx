      ...
      <Section title="Что умеет бот" icon="bi-list-check">
        <ul className="text-[12px] text-text-muted leading-relaxed space-y-1.5">
          <li>
            ...
            Команда <code className="font-mono text-[11px]">/chats</code> переключает разговор,{' '}
            <code className="font-mono text-[11px]">/new</code> заводит новый.
          </li>
          <li>
            · Принимает фото и файлы. Картинку опишет назначенная для этого модель, и описание
            останется в переписке текстом — вложение стоит токенов один раз.
          </li>
          <li>· Дорисовывает ответ по мере генерации, а не молчит до конца прогона.</li>
          <li>
