...
/**
 * Запись в каталоге проверенных плагинов.
 *
 * Каталог лежит в отдельном репозитории и обновляется без новой версии ядра.
 * Копия едет и в сборке: у Axon нет обязательного облака, и раздел «Каталог»,
 * пустой без интернета, был бы издевательством.
 */
