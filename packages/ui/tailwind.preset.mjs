/**
 * Тема Axon: цвета, шрифты, тени, движение.
 *
 * Лежит в общем пакете интерфейса, потому что относится к нему, а не к
 * приложению. Десктоп и телефон подключают её пресетом и добавляют только
 * свои пути для сканирования классов.
 */
